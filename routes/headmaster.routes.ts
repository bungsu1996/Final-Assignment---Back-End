...
class headmasterRoutes {
  ...
  protected headmasterControlTeacher = () => {
    ...
    this.headmasterRoute.post("/teacher/add-course/:id", TeacherController.addSpesificCourse);
    this.headmasterRoute.put("/teacher/update-course/:id", TeacherController.updateSpesificCourse);
  };
  protected headmasterControlHomeroom = () => {
    this.headmasterRoute.post("/homeroom/set-roomteacher", homeroomController.setHomeroom);
    ...
    this.headmasterRoute.get("/homeroom/student/:id", homeroomController.scoreByClassHomeroom);
  ...
  protected headmasterControlClasses = () => {
    ...
    this.headmasterRoute.put("/class/set-hometeach", ClassConttroller.setHomeroom);
    ...
    this.headmasterRoute.put("/class/change/:student", ClassConttroller.changeClass);
  };
  protected headmasterControlCourse = () => {
    ...
    this.headmasterRoute.post("/course/set-course", coursesController.setCourseTeacher);
    this.headmasterRoute.post("/course/update-course", coursesController.updateCourseTeacher);
  };
  ...
  protected headmasterControlSchedule = () => {
    this.headmasterRoute.post("/schedule/create", scheduleController.createSchedule);
    this.headmasterRoute.get("/schedule", scheduleController.listSchedule);
    this.headmasterRoute.get("/schedule/:id", scheduleController.spesificSchedule);
