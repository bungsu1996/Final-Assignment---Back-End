...
var headmasterRoutes = /** @class */ (function () {
    function headmasterRoutes() {
        ...
        this.headmasterControlStudent = function () {
            ...
            _this.headmasterRoute.put("/student/to-deadactive/:id", students_controller_1.default.toDeadActive);
            _this.headmasterRoute.put("/student/to-active/:id", students_controller_1.default.toActive);
        };
        ...
        this.headmasterControlSchedule = function () {
            ...
            _this.headmasterRoute.post("/calendar/create", calendar_controller_1.default.addNewSchedule);
            _this.headmasterRoute.get("/calendar/:id", calendar_controller_1.default.findSchedule);
            _this.headmasterRoute.get("/calendar", calendar_controller_1.default.findAllSchedule);
